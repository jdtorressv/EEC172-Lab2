...
/* This function sends the command byte "c" to the OLED 
*  via SPI.
*/
    // Dummy var for use in DataGet()
    unsigned long dummy = 0;

    // Cast byte to unsigned long
    unsigned long dataout = (unsigned long)c;

    // Differentiate between data and command: Command
    GPIOPinWrite(GPIOA2_BASE, 0x40, 0x00);

    // Enable Chip Select 
    MAP_SPICSEnable(GSPI_BASE);

    // Gpiocsenable SET GPIO TO LOW
    GPIOPinWrite(GPIOA0_BASE, 0x40, 0x00);

    // Put command 
    MAP_SPIDataPut(GSPI_BASE, c);

    // Get command; not used 
    MAP_SPIDataGet(GSPI_BASE, &dummy);

    //TODO: gpiocsdisable SET GPIO TO HIGH
...
//TODO 2
/* This function sends data byte "c" to the OLED
*  via SPI.
*/
    // Dummy var for use in DataGet() 
    unsigned long dummy = 0;
    ...
    // Differentiate between data and command: Data 
    ...
    // Gpiocsdisable SET GPIO TO HIGH
    GPIOPinWrite(GPIOA0_BASE, 0x40, 0x40);
